...
export default function TeachersPage() {
  ...
  async function saveTeacher(event: React.FormEvent) {
    ...
    if (result.error) toast.error(result.error.code === '23505' ? 'A teacher with that email already exists' : 'Unable to save teacher')
  ...
  return <div className="flex flex-col gap-6">
    <PageHeader title="Teachers" description="Manage your faculty directory and subject assignments."><Button onClick={startCreate}><Plus data-icon="inline-start" />Add teacher</Button></PageHeader>
